...
urlpatterns = [
    ...
    path('panel/categories/add/', panel_views.panel_category_edit, name='panel_category_add'),
    path('panel/categories/<int:pk>/', panel_views.panel_category_edit, name='panel_category_edit'),
